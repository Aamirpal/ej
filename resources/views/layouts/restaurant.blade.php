         ...
         <aside class="main-sidebar">
            ...
            <section class="sidebar">
               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="treeview">
                     <a href="{{url(Request::route()->getPrefix().'/edit/')}}">
                     <i class="fa fa-table"></i> <span>Bar Info</span>
                     </a>
                  </li>
                  <li class="treeview">
                     <a href="{{url(Request::route()->getPrefix().'/menu')}}">
                     <i class="fa fa-table"></i> <span>Menu</span>
                     </a>
                  </li>
                  <li class="treeview">
                     <a href="{{url(Request::route()->getPrefix().'/account')}}">
                     <i class="fa fa-table"></i> <span>Account</span>
                     </a>
                  </li>
                  <li class="treeview">
                     <a href="{{url(Request::route()->getPrefix().'/')}}">
                     <i class="fa fa-table"></i> <span>Analytics</span>
                     </a>
                  </li>
               </ul>
            </section>
